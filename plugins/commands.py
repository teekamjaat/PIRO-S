...
async def start(client:Client, message): 
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎥 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url='https://t.me/+siIP7Jook-xiYThl')
        ]]   
    ...
    if settings.get('fsub_id', AUTH_CHANNEL) and not await is_subscribed(client, message.from_user.id, channel):
        ...
        btn = [[
            ...
            InlineKeyboardButton("⛔️ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 2 ⛔️", url='https://t.me/+5yfKFrboKCMzYWQ9')
        ],[
            InlineKeyboardButton("⛔️ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 3 ⛔️", url='https://t.me/+YfHQgQlLxDFiYTM1')
        ],[
            InlineKeyboardButton("⛔️ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 4 ⛔️", url='https://t.me/+EphbjVdhh7gwYzY1')
        ]]

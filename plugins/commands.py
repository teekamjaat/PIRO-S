...
async def start(client:Client, message): 
    ...
    if settings.get('fsub_id', AUTH_CHANNEL) and not await is_subscribed(client, message.from_user.id, channel):
        ...
        btn = [[
            ...
            InlineKeyboardButton("⛔️ ᴊᴏɪɴ  ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ⛔️", url='https://t.me/+nhX_Ja7Oa9BjMzM9')
        ],[
            InlineKeyboardButton("⛔️ ᴊᴏɪɴ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ⛔️", url='https://t.me/+5yfKFrboKCMzYWQ9')
        ],[
            InlineKeyboardButton("⛔️ᴊᴏɪɴ ᴄʀɪᴄᴋᴇᴛ ᴘʀᴇᴅɪᴄᴛɪᴏɴ ⛔️", url='https://t.me/+lmirDxYPD05mZDc1')
        ]]

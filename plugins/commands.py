...
async def start(client:Client, message): 
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('👨‍💻 ᴏᴡɴᴇʀ', url='https://t.me/Master_xkid'),
            InlineKeyboardButton('💎 ᴘʀᴇᴍɪᴜᴍ', callback_data='buy_premium')
        ],[
            InlineKeyboardButton('🎬 ᴄʜᴀɴɴᴇʟ', url='https://t.me/Askmovies4'),
            InlineKeyboardButton('🎥 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url='https://t.me/Askmovieslink1')
        ]]   
